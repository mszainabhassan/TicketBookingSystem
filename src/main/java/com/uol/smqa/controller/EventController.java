...
public class EventController {
    ...
    public ResponseEntity<?> applyCouponCode(@Validated @RequestBody DiscountRequestDTO discountRequestDTO, BindingResult bindingResult) {
        ...
        try {
            ...
            return new ResponseEntity<>(eventService.applyCouponCode(discountRequestDTO), HttpStatus.OK);
