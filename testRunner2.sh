...
java -javaagent:jacoco-0.8.11/lib/jacocoagent.jar -jar jacoco-0.8.11/lib/jacococli.jar report jacoco.exec --classfiles classes --sourcefiles src --html report
