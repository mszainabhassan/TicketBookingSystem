...
java -javaagent:jacoco-0.8.8/lib/jacocoagent.jar -jar jacoco-0.8.8/lib/jacococli.jar report jacoco.exec --classfiles classes --sourcefiles src/main/java --html report
java -javaagent:jacoco-0.8.8/lib/jacocoagent.jar=includes=com/uol/smqa,* -jar jacoco-0.8.8/lib/jacococli.jar report jacoco.exec --classfiles classes --sourcefiles src/main/java --html report
